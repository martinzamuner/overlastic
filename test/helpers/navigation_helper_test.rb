...
class Overlastic::NavigationHelperTest < ActionView::TestCase
  test "link_to_overlay without args" do
    assert_no_match "data-overlay-args", link_to_overlay("Link", new_article_path)
  end
  ...
  test "link_to_overlay with explicit type" do
    assert_match 'data-overlay-type="dialog"', link_to_overlay("Link", new_article_path, overlay_type: :dialog)
  end

  test "link_to_overlay without explicit action" do
    assert_match 'data-turbo-frame="overlay33"', link_to_overlay("Link", new_article_path)
  end

  test "link_to_overlay with action replace_last" do
    assert_match 'data-turbo-frame="overlay32"', link_to_overlay("Link", new_article_path, overlay_action: :replace_last)
  end

  test "link_to_overlay with action replace_all" do
    assert_match 'data-turbo-frame="overlay1"', link_to_overlay("Link", new_article_path, overlay_action: :replace_all)
  end

  test "link_to_dialog" do
    assert_match 'data-overlay-type="dialog"', link_to_dialog("Link", new_article_path)
  end
end
